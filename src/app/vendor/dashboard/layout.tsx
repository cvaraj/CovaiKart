...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: "/vendor/dashboard/orders", icon: ShoppingCart, label: "Orders", badge: "6" },
    { href: "/vendor/dashboard/products", icon: Package, label: "Products" },
    { href: "/vendor/dashboard/categories", icon: Tags, label: "Categories" },
    { href: "/vendor/dashboard/inventory", icon: Warehouse, label: "Inventory" },
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-16 items-center border-b px-4 lg:h-[60px] lg:px-6">
            <Link href="/" className="flex items-center gap-2 font-semibold">
              ...
              <span className="">KonguMart Vendor</span>
            </Link>
